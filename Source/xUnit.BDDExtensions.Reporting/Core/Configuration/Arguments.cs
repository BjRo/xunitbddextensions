...
namespace Xunit.Reporting.Core.Configuration
{
    ...
    {
        private readonly IArgumentMap argumentMap;
        ...
        {
            Require.ArgumentNotNull(argumentMap, "argumentMap");
        ...
        {
            Require.ArgumentNotNull(key, "key");

            return key.ParseValue(argumentMap);
        }
