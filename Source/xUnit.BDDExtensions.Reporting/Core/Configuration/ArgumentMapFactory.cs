...
namespace Xunit.Reporting.Core.Configuration
{
    ...
    {
        private readonly Func<IEnumerable<string>> consoleArgsGetter;

        /// <summary>
        /// Creates a new instance of the <see <see cref="ArgumentMapFactory"/>
        /// </summary>
        /// <param name="consoleArgsGetter">
        /// Specifies a delegate for obtaining the console arguments.
        /// </param>
        public ArgumentMapFactory(Func<IEnumerable<string>> consoleArgsGetter)
        {
            Require.ArgumentNotNull(consoleArgsGetter, "consoleArgsGetter");

            this.consoleArgsGetter = consoleArgsGetter;
        }
        ...
        {
            var consoleArgs = consoleArgsGetter();
        ...
        /// </summary>
        /// <param name="input">Specifies the consoleArgsGetter collection.</param>
