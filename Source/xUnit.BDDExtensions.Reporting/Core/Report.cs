...
namespace Xunit.Reporting.Core
{
    ...
    {
        private readonly IEnumerable<Concern> collectedConcerns;
        private readonly IAssembly reflectedAssembly;
        ...
        {
            this.collectedConcerns = collectedConcerns;
            this.reflectedAssembly = reflectedAssembly;
        }
        ...
        {
            get { return reflectedAssembly.Name; }
        }
        ...
        {
            get { return collectedConcerns.Count(); }
        }
        ...
        {
            get { return collectedConcerns.Sum(concern => concern.AmountOfContexts); }
        }
        ...
        {
            get { return collectedConcerns.Sum(concern => concern.AmountOfObservations); }
        }

        public IEnumerator<Concern> GetEnumerator()
        {
            foreach (var collectedConcern in collectedConcerns)
            {
