...
namespace Xunit.Reporting.Internal.Generator
{
    ...
    {
        private readonly IAssembly _assemblyContainingVelocity;
        private readonly IDirectiveManager _directiveManager;
        ...
        public void Register(string directiveTypeName)
        {
            ...
            _directiveManager.Register(updatedDirective);
        }
        ...
        {
            return _directiveManager.Create(name, directiveStack);
        }
        ...
        {
            return _directiveManager.Contains(directiveName);
        }
        ...
        {
            return !string.Equals(_assemblyContainingVelocity.Name, "NVelocity");
        }
