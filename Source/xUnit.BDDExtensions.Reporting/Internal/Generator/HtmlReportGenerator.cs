...
namespace Xunit.Reporting.Internal.Generator
{
    ...
    {
        private readonly IFileWriter _outputWriter;
        ...
        public void Generate(IReport report)
        {
            ...
            properties.AddProperty("directive.manager",
                                   EncodeExternalAssemblyQualifiedType(typeof (DirectiveManagerProxy)));
            properties.AddProperty("assembly.resource.loader.class",
                                   typeof (AssemblyResourceLoader).AssemblyQualifiedName);
