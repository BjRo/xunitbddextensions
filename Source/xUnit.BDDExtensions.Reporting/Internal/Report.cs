...
namespace Xunit.Reporting.Internal
{
    ...
    public class Report : IReport
    {
        ...
        {
            get { return _reflectedAssembly.Name; }
        }
        ...
        {
            get { return _collectedConcerns.Count(); }
        }
        ...
        {
            get { return _collectedConcerns.Sum(concern => concern.AmountOfContexts); }
        }
        ...
        {
            get { return _collectedConcerns.Sum(concern => concern.AmountOfObservations); }
        }
